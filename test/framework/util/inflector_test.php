...
<?
   ...
   class InflectionsTest extends TestCase
   {
      ...
      function test_singularize_singulars() {
         $this->assertEqual('singular', singularize('singular'));
         $this->assertEqual('Singular', singularize('Singular'));
         $this->assertEqual('alias', singularize('alias'));
         $this->assertEqual('status', singularize('status'));
      }
